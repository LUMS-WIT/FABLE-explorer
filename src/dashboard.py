#!/usr/bin/env python
"""
Streamlit dashboard for exploring FABLE Pakistan all-pathways outputs.
...
def main() -> None:
    st.set_page_config(page_title="FABLE Pakistan All-Pathways Dashboard", layout="wide")
    st.title("FABLE Pakistan All-Pathways Dashboard")
