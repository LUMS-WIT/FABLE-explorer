#!/usr/bin/env python
"""
Tkinter launcher for FableVisualizerV4 all-pathways runner + Streamlit dashboard.
...
from FableVisualizerV4_AllPathwaysRunner import run_all_pathways


class FableLauncher(tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("FableVisualizerV4 Launcher")
    ...
    def _launch_streamlit(self) -> None:
        dash_path = Path(__file__).parent / "FableVisualizerV4_Dashboard.py"
